...
class MetaPathGenerator:
    ...
    def generate_random_aca(self, outfilename, numwalks, walklength):
        for conf in tqdm(self.conf_paper):
        ...
        for conf in tqdm(self.conf_authorlist):
            conf0 = conf
...
# python py4genMetaPaths.py 1000 100 net_socialpj output.socialpj.w1000.l100.txt

dirpath = "net_socialpj"
